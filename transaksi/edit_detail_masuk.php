...
// Ambil data lama
$data = getDetailBarangmasuk($id_transaksi, $id_barang);

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $jumlah = $_POST['jumlah'];
    $harga  = $_POST['harga'];

    updateDetailBarangmasuk($id_transaksi, $id_barang, $jumlah, $harga);
...
<div class="container mt-4">
    ...
    <form method="POST">
        ...
        <a href="read_masuk.php?id=<?= $id_transaksi ?>" class="btn btn-secondary">Kembali</a>
    </form>
</div>
